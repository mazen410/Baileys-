        ...
        async handleAlbum(content, jid, quoted) {
            ...
            for (let content of array) {
                ...
                img.message.forwardedNewsletterMessageInfo = {
                    newsletterJid: "120363424275625458@newsletter",
                    serverMessageId: 1,
                        ...
                        eventMessage: {
                            contextInfo: {
                                ...
                                forwardedNewsletterMessageInfo: {
                                    ...
                                    newsletterJid: "120363424275625458@news6letter",
                                    serverMessageId: 1
                                }
                            },
            ...
            const msg = await this.utils.generateWAMessageFromContent(jid, {
                pollResultSnapshotMessage: {
                    ...
                    contextInfo: {
                        ...
                        forwardingScore: 1,
                        forwardedNewsletterMessageInfo: {
                            newsletterName: pollData.newsletter.newsletterName || "120363424275625458@newsletter",
